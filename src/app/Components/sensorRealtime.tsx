...
const SensorRealtime: React.FC<SensorRealtimeProps> = ({
    sensor, suhu, humid, nitrogen, fosfor, kalium, ph, ec, tds,
    statusPh, statusSuhu, statusNitrogen, statusFosfor,
    statusKalium, statusHumid, statusEc, statusTDS
}) => {
    return (
        <div className="mt-5">
            <h3 className="font-bold text-xl md:text-2xl mb-3 md:mb-5">Area {sensor}</h3>
            <div className="bg-abu w-full rounded-md grid grid-cols-2 sm:grid-cols-4 gap-2 p-2 md:p-4">
