...
const SensorRealtime: React.FC<SensorRealtimeProps> = ({
    sensor, nitrogen, fosfor, kalium, ph,
    statusPh, statusNitrogen, statusFosfor, statusKalium
}) => {
    return (
        <div className="mt-5">
            <div className="bg-abu w-full rounded-md p-2 md:p-4 shadow-md">
                <h3 className="font-bold text-xl md:text-2xl mb-3 md:mb-5 w-full">Area {sensor}</h3>
