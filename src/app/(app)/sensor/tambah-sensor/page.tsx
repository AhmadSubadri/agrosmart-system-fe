        ...
        <div className="mt-6 ml-6 bg-abu p-4">
          ...
          <form action="#" className="max-w-screen-md mx-0 space-y-10">
            <div id="idArea" className="flex space-x-5 items-center mb-2">
              <label
                htmlFor="idArea"
                className="text-black text-base font-bold w-32"
              >
                ID
              </label>
              <input
            ...
            <div id="aksi" className="space-x-5 mt-6">
              ...
              <input
                type="submit"
                value="Tambah"
                className="bg-primary text-white rounded-md p-3 cursor-pointer hover:bg-secondary"
              />
            </div>
          </form>
        </div>
